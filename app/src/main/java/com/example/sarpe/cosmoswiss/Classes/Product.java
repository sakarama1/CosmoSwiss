...
public class Product {
    ...
    public Product(String code, String nameEnglish, String nameGerman, String brand, String mainCategory, String subCategory, String barcode, String costSalon, String costWeb, String picture, String quantity) {
        this.code = code;
